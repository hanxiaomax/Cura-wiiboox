...
def encode_payload(payload): #payload为参数 生成一个packet
    """
...
def decode_packet(packet):
    ...
    return packet[2:(len(packet) - 1)] #return 的是 payload


def check_response_code(response_code): #Response Code就是收到的Response第一个字节
    """
